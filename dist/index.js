...
const utils_1 = __nccwpck_require__(594);
/**
 * Commands
 *
 * Command Format:
...
const command_1 = __nccwpck_require__(671);
const file_command_1 = __nccwpck_require__(194);
const utils_1 = __nccwpck_require__(594);
const os = __importStar(__nccwpck_require__(37));
const path = __importStar(__nccwpck_require__(17));
const oidc_utils_1 = __nccwpck_require__(952);
/**
...
const http_client_1 = __nccwpck_require__(499);
const auth_1 = __nccwpck_require__(897);
const core_1 = __nccwpck_require__(984);
class OidcClient {
...
const pm = __nccwpck_require__(546);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(659);
            }
            const agentOptions = {
...
module.exports = __nccwpck_require__(626);
...
if (!globalThis.ReadableStream) {
  ...
  try {
    ...
    Object.assign(globalThis, __nccwpck_require__(341))
  }
}
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(508);
...
var node_domexception = __nccwpck_require__(629);
// EXTERNAL MODULE: ./node_modules/fetch-blob/file.js
var file = __nccwpck_require__(613);
// EXTERNAL MODULE: ./node_modules/fetch-blob/index.js
var fetch_blob = __nccwpck_require__(508);
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(728);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(508);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(613);
...
var esm_min = __nccwpck_require__(253);
...
var from = __nccwpck_require__(870);
